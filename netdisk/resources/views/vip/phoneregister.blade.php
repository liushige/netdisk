    ...
    <form name="loginform" id="loginform" action="{{ url('vip/dophoneregister') }}" method="post">
        ...
        <p>
            <label for="user_login">用户名<br>
                <input type="text" name="username" required class="input" value="" maxlength="20" minlength="3" size="20"></label>
        </p>
        <p>
        ...
        <p>
            <label for="user_pass">密码<br>
                <input type="password" name="user_pass" required id="user_pass" class="input" value="" maxlength="20" minlength="6" size="20"></label>
        </p>
        <p>
