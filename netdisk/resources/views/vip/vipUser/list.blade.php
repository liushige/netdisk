            ...
            <div class="layui-row layui-col-space15">
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body ">
                            <div class="page">
                                <div class="layui-inline layui-show-xs-block"> {!! $vip->appends($request->all())->render() !!} </div>
                                <div class="layui-inline layui-show-xs-block">共有 {!! $vip->total() !!} 条记录</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
              $.post('/vip/vipUser/'+id,{"_method":"delete","_token":"{{ csrf_token() }}"},function (data) {
                    if(data==0){
                        //发异步删除数据
      ...
      function delAll (argument) {
        ...
        layer.confirm('确认要删除吗？',function(index){
            $.get('/vip/vipUser/del',{'ids':ids},function (data) {
                if(data==0){
                    //捉到所有被选中的，发异步进行删除
